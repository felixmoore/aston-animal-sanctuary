{{-- From https://tailwindcomponents.com/component/alert-with-dismiss-button --}}
<div class="space-x-2 bg-green-50 p-4 rounded flex items-center text-green-600 my-4 shadow-lg mx-auto max-w-2xl">
    <div class="">
