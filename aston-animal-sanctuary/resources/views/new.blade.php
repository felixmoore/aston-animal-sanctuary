...
<body class="leading-normal tracking-normal gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <div class="mx-auto max-w-6xl bg-white py-20 px-12 lg:px-24 shadow-xl mb-24">
        ...
        <div class="w-1/2 p-2">
					...
					<a href="#" class="block text-xl text-center">All animals</a>
				</div>
				...
				<div class="w-1/2 p-2">
					...
					<a href="#" class="block text-xl text-center">Cats</a>
				</div>
				...
				<div class="w-1/2 p-2">
					...
					<a href="#" class="block text-xl text-center">Dogs</a>
				</div>
				...
				<div class="w-1/2 p-2">
					...
					<a href="#" class="block text-xl text-center">Small animals</a>
				</div>
